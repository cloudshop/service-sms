...
import com.eyun.cloud.domain.Message;
import com.eyun.cloud.repository.MessageRepository;
import com.eyun.cloud.service.MessageService;
import com.eyun.cloud.service.dto.MessageDTO;
import com.eyun.cloud.service.mapper.MessageMapper;
...
public class MessageResourceIntTest {
    ...
    private static final Instant DEFAULT_ADDEDTIME = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_ADDEDTIME = Instant.now().truncatedTo(ChronoUnit.MILLIS);

    private static final Instant DEFAULT_SENTTIME = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_SENTTIME = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    private static final State UPDATED_STATE = State.FAILED;
    ...
    public void createMessage() throws Exception {
        ...
        assertThat(testMessage.getAppkey()).isEqualTo(DEFAULT_APPKEY);
        ...
        assertThat(testMessage.getAddedtime()).isEqualTo(DEFAULT_ADDEDTIME);
        assertThat(testMessage.getSenttime()).isEqualTo(DEFAULT_SENTTIME);
    ...
    public void getAllMessages() throws Exception {
        ...
        restMessageMockMvc.perform(get("/api/messages?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].addedtime").value(hasItem(DEFAULT_ADDEDTIME.toString())))
            .andExpect(jsonPath("$.[*].senttime").value(hasItem(DEFAULT_SENTTIME.toString())))
    ...
    public void getMessage() throws Exception {
        ...
        restMessageMockMvc.perform(get("/api/messages/{id}", message.getId()))
            ...
            .andExpect(jsonPath("$.addedtime").value(DEFAULT_ADDEDTIME.toString()))
            .andExpect(jsonPath("$.senttime").value(DEFAULT_SENTTIME.toString()))
    ...
    public void updateMessage() throws Exception {
        ...
        Message testMessage = messageList.get(messageList.size() - 1);
        assertThat(testMessage.getAppkey()).isEqualTo(UPDATED_APPKEY);
        ...
        assertThat(testMessage.getAddedtime()).isEqualTo(UPDATED_ADDEDTIME);
        assertThat(testMessage.getSenttime()).isEqualTo(UPDATED_SENTTIME);
